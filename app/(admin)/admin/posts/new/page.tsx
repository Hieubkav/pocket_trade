  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Thêm Bài Viết Mới</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Tạo bài viết mới</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              ...
              <input
                ...
                placeholder="VD: Hướng dẫn trade Pokémon TCG Pocket"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                placeholder="huong-dan-trade-pokemon-tcg-pocket"
              />
            </div>
