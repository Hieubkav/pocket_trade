  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Chỉnh Sửa Sự Kiện</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Cập nhật thông tin sự kiện</p>
        </div>
      </div>
            ...
            <div className="md:col-span-2">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="text-sm font-medium text-slate-700 dark:text-slate-300">
                  Kích hoạt (chỉ 1 sự kiện được kích hoạt tại một thời điểm)
                </span>
              </label>
            </div>
          </div>
